...
/**
 * Exception thrown when upstream system throw an error response.
 * This exception is typically used to indicate that there is something
 * went wrong with external dependency system.
 */
